...
Recorded on 2026-09-14 with Node.js 22.14.0 for Windows x64 on an Intel Core
...
same implementation beyond 12 MB/s, slightly ahead of
...
The original Kuznyechik constructor regenerated the 32 standard iteration
constants and transformed decryption keys with bit-at-a-time GF multiplication.
Caching the constants and using the same lookup/fused-table strategy as the
round functions reduced key setup from 718.8 us in the previous reference run
to 6.2 us.
